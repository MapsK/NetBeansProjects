...
public class JMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Add", "Subtract", "Multiply", "Division" }));
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        Num1 = Float.parseFloat(Txt1);
        Num2 = Float.parseFloat(Txt2);
        ...
        switch(Select) {
            case "Add":
                ...
                jTextField3.setText(Ans2);
            break;
            case "Subtract":
                Ans = Num1 - Num2;
                Ans2 = String.valueOf(Ans);
                jTextField3.setText(Ans2);
            break;
            case "Mult":
             Ans = Num1 * Num2;
